export default {
  ...
  modal: {
    ...
    create_module: 'Create new planning module',
    edit_module: 'Edit planning module',
    in_information:
      'No input information | 1 input information | {count} input informations',
    out_information:
      'No output information | 1 output information | {count} output informations',
  ...
  example_drafts: {
    meta: {
      num_planningmodules:
        'No planning module | 1 planning module | {count} planning modules',
      num_informations:
        'No information types | 1 information type | {count} information types'
    },
  ...
  warning: {
    ...
    no_module_selected: 'No planning module selected!',
